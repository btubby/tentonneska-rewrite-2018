                ...
                <SocialContainer>
                  <SocialIconContainer>
                    <SocialIcon
                      network="instagram"
                      target="_blank"
                      url="https://www.instagram.com/tentonneska/"
                      bgColor="#00bb00"
                    />
                  </SocialIconContainer>
                  <SocialIconContainer>
                    <SocialIcon
                      network="facebook"
                      target="_blank"
                      url="https://www.facebook.com/TenTonneSka/"
                      bgColor="#00bb00"
                    />
                  </SocialIconContainer>
                  <SocialIconContainer>
                    <SocialIcon
                      network="soundcloud"
                      target="_blank"
                      url="https://soundcloud.com/tentonneska"
                      bgColor="#00bb00"
                    />
                  </SocialIconContainer>
                  <SocialIconContainer>
                    <SocialIcon
                      network="youtube"
                      target="_blank"
                      url="https://www.youtube.com/channel/UCyll8SRJR-gIoQ__o5udO7g"
                      bgColor="#00bb00"
                    />
                  </SocialIconContainer>
                </SocialContainer>
